...
class BridgeData(object):
    def __init__(self):
        ...
        self.priority_usernames =  list(filter(os.environ.get("HORDE_PRIORITY_USERNAMES", "").split(","),lambda a : a))
        ...
        self.blacklist = list(filter(os.environ.get("HORDE_BLACKLIST", "").split(","),lambda a : a))
        self.censorlist =  list(filter(os.environ.get("HORDE_CENSORLIST", "").split(","),lambda a : a))
